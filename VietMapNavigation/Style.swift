...
public class ResumeButton: UIControl {
    ...
    let imageView = UIImageView(image: UIImage(named: "location", in: .VietMapNavigation, compatibleWith: nil)!.withRenderingMode(.alwaysTemplate))
    ...
    func commonInit() {
        self.titleLabel.text = NSLocalizedString("RESUME", bundle: .VietMapNavigation, value: "Resume", comment: "Button title for resume tracking")

...
//                showsUserLocation = true
    ...
    public func updateCourseTracking(location: CLLocation?, camera: MLNMapCamera? = nil, animated: Bool = false, updateUserCourse: Bool = false) {
        ...
        if tracksUserCourse {
            ...
            let newCamera = camera ?? MLNMapCamera(lookingAtCenter: coordinate, altitude: altitude, pitch: 45, heading: location.course)
